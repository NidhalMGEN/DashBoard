...
-- =======================================================================
-- Comptage du nombre total de contrats individuels et de doublons par code offre
...
-- bénéficiaires effectivement porteurs d'un NIR.
Final AS (
    ...
    WHERE A.ACH2CODTAS = 'ASSPRI'
      ...
      -- Exclusion des offres de prévoyance
      AND O.ACOFCODOFF NOT IN (
      ...
      -- AND O.ACOFCODOFF = 'INPPREVINDBIS'
),
