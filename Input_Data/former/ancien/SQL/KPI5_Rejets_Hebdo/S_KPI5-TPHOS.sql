...
-- ============================================================================
-- KPI5 - Plus ancien rejet pour origine = 'TPHOS'
-- Decline de la requete globale S_KPI5-Min_Max_DSI_rejets.sql.
-- Le pre-filtre PSEPCODORI = 'TPHOS' est applique au plus tot (CTE 'ori')
...
-- Code rejet : dernier rejet du dossier (sur dossiers 'TPHOS' uniquement)
rj AS (
