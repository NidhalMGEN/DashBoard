...
-- ============================================================================
-- KPI5 - Plus ancien rejet pour origine = 'TPVIA'
-- Decline de la requete globale S_KPI5-Min_Max_DSI_rejets.sql.
-- Le pre-filtre PSEPCODORI = 'TPVIA' est applique au plus tot (CTE 'ori')
...
-- Code rejet : dernier rejet du dossier (sur dossiers 'TPVIA' uniquement)
rj AS (
