...
-- ============================================================================
-- KPI5 - Plus ancien rejet pour origine = 'TPCVM'
-- Decline de la requete globale S_KPI5-Min_Max_DSI_rejets.sql.
-- Le pre-filtre PSEPCODORI = 'TPCVM' est applique au plus tot (CTE 'ori')
...
-- Code rejet : dernier rejet du dossier (sur dossiers 'TPCVM' uniquement)
rj AS (
