/* BATCH 1 | GENERATED 2026-08-03 11:52:57.231326 | SOURCE: 16042026 | NB: 7 */
...
FROM (
  ...
  WHERE usr.realm_id != 'master'
    ...
    AND (
      (attmiddle.value ILIKE 'BAUTRAIT' AND usr.first_name ILIKE 'Clarisse')
      OR (attmiddle.value ILIKE 'CARDINEAUD' AND usr.first_name ILIKE 'SOLENE')
      OR (attmiddle.value ILIKE 'DESCHAMPS' AND usr.first_name ILIKE 'JULIEN')
      OR (attmiddle.value ILIKE 'LEPERRE' AND usr.first_name ILIKE 'PIERRE YANNICK')
      OR (attmiddle.value ILIKE 'MOKADEM' AND usr.first_name ILIKE 'YACINE')
      OR (attmiddle.value ILIKE 'MOKCITE' AND usr.first_name ILIKE 'MEHDI')
      OR (attmiddle.value ILIKE 'VALDIZAN' AND usr.first_name ILIKE 'ALEXANDRA')
    )
