/* BATCH 1 | GENERATED 2026-08-13 12:03:04.286612 | SOURCE: 31072026 | NB: 26 */
...
FROM (
  ...
  WHERE usr.realm_id != 'master'
    ...
    AND (
      (attmiddle.value ILIKE 'AFFI' AND att2.value = '1989-08-10')
      OR (attmiddle.value ILIKE 'BENZ' AND att2.value = '1986-04-16')
      OR (attmiddle.value ILIKE 'BESARAB' AND att2.value = '1991-02-20')
      OR (attmiddle.value ILIKE 'CABANIE' AND att2.value = '1970-02-26')
      OR (attmiddle.value ILIKE 'CANDAU' AND att2.value = '2005-03-09')
      OR (attmiddle.value ILIKE 'CRESPIN' AND att2.value = '2000-08-01')
      OR (attmiddle.value ILIKE 'DAVID' AND att2.value = '1993-04-29')
      OR (attmiddle.value ILIKE 'DELHOUM' AND att2.value = '2004-09-14')
      OR (attmiddle.value ILIKE 'DELOTAL' AND att2.value = '1981-01-20')
      OR (attmiddle.value ILIKE 'DOS SANTOS' AND att2.value = '1942-04-08')
      OR (attmiddle.value ILIKE 'FONTAINE' AND att2.value = '2006-11-20')
      OR (attmiddle.value ILIKE 'GUILLEMIN' AND att2.value = '1984-12-19')
      OR (attmiddle.value ILIKE 'Gauzieux' AND att2.value = '1993-08-31')
      OR (attmiddle.value ILIKE 'JAFARI' AND att2.value = '1996-07-21')
      OR (attmiddle.value ILIKE 'KARINDROU' AND att2.value = '1993-12-03')
      OR (attmiddle.value ILIKE 'LAVERGNE MARTENOT' AND att2.value = '1981-05-18')
      OR (attmiddle.value ILIKE 'LEVET' AND att2.value = '1984-03-14')
      OR (attmiddle.value ILIKE 'MEHIAOUI' AND att2.value = '2007-02-12')
      OR (attmiddle.value ILIKE 'MEYER' AND att2.value = '1956-03-07')
      OR (attmiddle.value ILIKE 'MORENAS' AND att2.value = '2006-07-28')
      OR (attmiddle.value ILIKE 'NDOLLOMASSALA' AND att2.value = '1986-06-10')
      OR (attmiddle.value ILIKE 'PAIS CORDEIRO' AND att2.value = '1983-02-20')
      OR (attmiddle.value ILIKE 'ROUSSEAU' AND att2.value = '1995-09-26')
      OR (attmiddle.value ILIKE 'THEVENIN' AND att2.value = '1983-08-31')
      OR (attmiddle.value ILIKE 'TIPLICA' AND att2.value = '2004-06-29')
      OR (attmiddle.value ILIKE 'TROCME' AND att2.value = '1955-11-07')
    )
