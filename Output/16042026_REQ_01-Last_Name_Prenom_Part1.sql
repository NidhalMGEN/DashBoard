/* BATCH 1 | GENERATED 2026-08-03 11:54:26.872002 | SOURCE: 16042026 | NB: 7 */
...
FROM (
  ...
  WHERE usr.realm_id != 'master'
    ...
    AND (
      (usr.last_name ILIKE 'BAUTRAIT' AND usr.first_name ILIKE 'Clarisse')
      OR (usr.last_name ILIKE 'CARDINEAUD' AND usr.first_name ILIKE 'SOLENE')
      OR (usr.last_name ILIKE 'DESCHAMPS' AND usr.first_name ILIKE 'JULIEN')
      OR (usr.last_name ILIKE 'LEPERRE' AND usr.first_name ILIKE 'PIERRE YANNICK')
      OR (usr.last_name ILIKE 'MOKADEM' AND usr.first_name ILIKE 'YACINE')
      OR (usr.last_name ILIKE 'MOKCITE' AND usr.first_name ILIKE 'MEHDI')
      OR (usr.last_name ILIKE 'VALDIZAN' AND usr.first_name ILIKE 'ALEXANDRA')
    )
