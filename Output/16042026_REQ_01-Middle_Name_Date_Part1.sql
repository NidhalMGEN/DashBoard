/* BATCH 1 | GENERATED 2026-08-03 11:54:26.883143 | SOURCE: 16042026 | NB: 7 */
...
FROM (
  ...
  WHERE usr.realm_id != 'master'
    ...
    AND (
      (attmiddle.value ILIKE 'BAUTRAIT' AND att2.value = '1979-09-27')
      OR (attmiddle.value ILIKE 'CARDINEAUD' AND att2.value = '1995-04-01')
      OR (attmiddle.value ILIKE 'DESCHAMPS' AND att2.value = '1978-10-03')
      OR (attmiddle.value ILIKE 'LEPERRE' AND att2.value = '1954-06-29')
      OR (attmiddle.value ILIKE 'MOKADEM' AND att2.value = '2002-02-22')
      OR (attmiddle.value ILIKE 'MOKCITE' AND att2.value = '1960-01-01')
      OR (attmiddle.value ILIKE 'VALDIZAN' AND att2.value = '1983-03-22')
    )
